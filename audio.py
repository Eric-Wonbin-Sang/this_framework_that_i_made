...
class AudioDevice:
    ...
    def get_all_devices(cls):
        """ Some variant of this method may be running a bunch of times (related to caching logic) TODO """
        return [
    ...
    def get_default_device(self):
        ...
        return self.p.get_host_api_info_by_type(pyaudio.paWASAPI)
    ...
    def audio_type(self):
        ...
        Note:
            I could make the default cls.INPUT as the only type that is OUTPUT is the
            Speaker class. I want to reuse this code for the window audio retrieval,
            so I'll make adjustments and I approach that.
        """
...
class LoopbackSpeaker(AudioDevice):
    ...
    def audio_type(self):
        ...
        return self.INPUT  # Loopback devices act as input devices.
